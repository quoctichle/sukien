...
.landing-title{z-index:3;color:#1f6b2e;font-weight:800;margin:12px 0 26px;text-align:center;font-size:42px;letter-spacing:0.6px;text-shadow:0 1px 0 rgba(255,255,255,0.06);max-width:760px;margin-left:auto;margin-right:auto}
.card-wrap{z-index:3;width:100%;display:flex;justify-content:center;max-width:100%;padding:0 4px}
.card{background:linear-gradient(180deg,#4aa25a,#3e8a42);padding:32px 50px;border-radius:var(--card-radius);-webkit-border-radius:var(--card-radius);-moz-border-radius:var(--card-radius);color:#fff;display:flex;flex-direction:column;gap:14px;box-shadow:0 20px 60px rgba(0,0,0,0.6);overflow:hidden;width:100%;max-width:760px}
...
.label{color:#1f6b2e;padding:0;border-radius:0;font-weight:800;background:transparent;text-align:left;line-height:1.2;font-size:16px;white-space:nowrap;flex-shrink:0}
